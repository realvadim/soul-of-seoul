...
<div id="content">
	<div style="margin-bottom:20px;">
		<object id="Object1" type="application/x-shockwave-flash" data="../videos/player_flv_maxi.swf" width="1000" height="480">
			...
			<param name="FlashVars" value="configxml=../videos/video1.xml" />
		</object>
	</div>
	<div style="background:#E9E9E9; height:200px; width:847px; margin-left:113px;">
		<div class="videoPreview" id="selected">
			<img src="./images/seoul_in_images/preview1.jpg" height="130" width="229" alt="Preview 1" id="selected" />					
		</div>
		<div class="videoPreview">
			<a href="seoul_in_images_2.php"><img src="./images/seoul_in_images/preview2.jpg" height="130" width="229" alt="Preview 2" /></a>
			<p><a href="seoul_in_images_2.php">watch this...</a></p>
		</div>
		<div class="videoPreview" style="margin-right:0;">
			...
			<p><a href="seoul_in_images_3.php">watch this...</a></p>
		</div>
	</div>		
</div>
<?php
